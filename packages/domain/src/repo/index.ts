export type { DiffSectionKind, GitFileStatus, RepositoryMode, RepositoryRole } from '#domain/common/index.js';

import type { DiffSectionKind, GitFileStatus, RepositoryMode, RepositoryRole } from '#domain/common/index.js';
 ...
 */
export const IMAGE_EXTENSIONS: ReadonlyArray<string> = ['.png', '.jpg', '.jpeg', '.gif', '.webp', '.svg', '.avif', '.ico', '.bmp'] as const;
