...
import type { ReviewComment, ReviewDetail, ReviewSession } from '@git-diff/domain';
...
describe('htmlToMarkdown', () => {
	test('paragraphs and bold/italic', () => {
		expect(htmlToMarkdown('<p>hello <strong>world</strong> <em>now</em></p>')).toBe('hello **world** _now_');
	});
