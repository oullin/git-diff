...
export function installApplicationMenu(): void {
	...
	const template: MenuItemConstructorOptions[] = [
		...
		{
			label: 'File',
			submenu: [newWindowItem(), { type: 'separator' }, isMac ? { role: 'close' } : { role: 'quit' }],
		},
		{ role: 'editMenu' },
		{
			label: 'View',
		...
		},
		{
			...
			submenu: [
				...
				{ role: 'zoom' },
				...(isMac
					? ([{ type: 'separator' }, { role: 'front' }, { type: 'separator' }, { role: 'window' }] satisfies MenuItemConstructorOptions[])
