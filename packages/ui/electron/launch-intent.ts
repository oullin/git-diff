...
const pullRequestUrlPattern = /^https?:\/\/github\.com\/[^/\s]+\/[^/\s]+\/pull\/([1-9]\d*)(?:[/?#].*)?$/i;
...
function classifyPositional(arg: string, cwd: string, walkthrough: boolean, opts: ClassifyOptions = {}): LaunchIntent {
