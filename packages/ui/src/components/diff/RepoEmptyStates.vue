...
<template>
    ...
    <div class="mx-auto w-full max-w-5xl px-8 pt-16 pb-10">
      <div class="hero">
        ...
        <p class="hero-subtitle">
          Inspect changes across your repositories with a fast file tree, side-by-side diffs, and
          lightweight local reviews.
        </p>
        <div class="hero-cta-row">
          <button class="toolbar-btn" type="button" @click="emit('add-repository')">
  ...
  <div v-else class="grid flex-1 place-items-center p-8">
    ...
    >
      ...
      <button class="mt-4 toolbar-btn" type="button" @click="emit('add-repository')">
