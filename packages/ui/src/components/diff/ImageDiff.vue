...
<template>
	...
	>
		...
		>
			...
			<div class="grid flex-1 place-items-center" :style="{ minHeight: '120px', overflow: 'hidden' }">
				<div v-if="side.missing" class="flex flex-col items-center gap-2 text-sm" :style="{ color: 'var(--gd-text-3)' }">
					<ImageOff :size="20" />
					<span>Not present</span>
				</div>
				<div v-else-if="side.loading" class="flex items-center gap-2 text-sm" :style="{ color: 'var(--gd-text-3)' }">
