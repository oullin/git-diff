    ...
    <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2.5">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <Select
                        ...
                        @update:model-value="
                            (value) => setKey('viewMode', value as Tweaks['viewMode'])
                        "
                    >
                ...
                <div class="flex items-center justify-between gap-3">
                    ...
                    <Select
                        ...
                        @update:model-value="
                            (value) => setKey('density', value as Tweaks['density'])
                        "
                    >
            ...
            <div class="flex flex-col gap-2.5">
                <div class="flex items-center justify-between gap-3">
                    ...
                    <Select
                        ...
                        @update:model-value="
                            (value) => setKey('diffStyle', value as Tweaks['diffStyle'])
                        "
                    >
        ...
        <section>
            ...
            <div class="flex flex-col gap-3">
                <div class="flex items-center justify-between gap-3">
                    <Label class="text-[12.5px] font-normal" :style="{ color: 'var(--gd-text-2)' }">
                        Mode
                    </Label>
                    <div
                    ...
                    >
                        <button
                            ...
                            :style="{
                                ...
                                cursor: 'pointer',
                                background:
                                    tweaks.theme === opt.value ? 'var(--gd-bg)' : 'transparent',
                                color:
                                    tweaks.theme === opt.value
                                        ? 'var(--gd-text)'
                                        : 'var(--gd-text-3)',
                                boxShadow:
                                    tweaks.theme === opt.value
                                        ? '0 1px 2px rgb(0 0 0 / 0.08), 0 0 0 1px var(--gd-border)'
                                        : 'none',
                    ...
                    <div class="flex items-center gap-2">
                        <button
                            ...
                            :style="{
                                ...
                                border:
                                    tweaks.accent === a.key
                                        ? '2px solid var(--gd-text)'
                                        : '2px solid var(--gd-border)',
                                boxShadow:
                                    tweaks.accent === a.key ? '0 0 0 2px var(--gd-panel)' : 'none',
                            }"
