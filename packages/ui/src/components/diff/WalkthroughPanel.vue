...
// Collapsed group IDs, keyed by walkthrough fingerprint so collapse state
// survives within one walkthrough but resets when the diff itself changes.
        ...
        <div v-else-if="record" class="flex flex-col gap-2">
            <div class="font-semibold">
                ...
                <span class="font-normal text-muted-foreground">
                    — {{ record.modelId }}
                    <span v-if="record.providerId" class="opacity-60">
                        ({{ record.providerId }})
                    </span>
                </span>
            </div>
                ...
                <div v-if="!isCollapsed(group.id)" class="px-3 py-2">
                    ...
                    <ol class="list-decimal pl-5 space-y-1">
                        ...
                        >
                            ...
                            <span v-if="file.note" class="ml-1 text-muted-foreground">
                                — {{ file.note }}
                            </span>
                        </li>
                    </ol>
