...
<template>
  ...
  >
    ...
    <button
      ...
      :disabled="!canUp || upInflight"
      :style="buttonStyle(canUp, upInflight)"
      @click="$emit('expand-up')"
    >
    ...
    <button
      ...
      :disabled="!canDown || downInflight"
      :style="buttonStyle(canDown, downInflight)"
      @click="$emit('expand-down')"
    >
