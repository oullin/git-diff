...
import { ChevronDown, Code, Heading1, Heading2, Heading3, List, ListOrdered, Pilcrow, Quote } from 'lucide-vue-next';
...
<template>
	<DropdownMenu :modal="false">
		...
		<DropdownMenuContent align="start" class="w-48">
			<DropdownMenuItem @select="setParagraph"> <Pilcrow class="mr-2 h-4 w-4" />Paragraph </DropdownMenuItem>
			<DropdownMenuItem @select="() => setHeading('h1')"> <Heading1 class="mr-2 h-4 w-4" />Heading 1 </DropdownMenuItem>
			<DropdownMenuItem @select="() => setHeading('h2')"> <Heading2 class="mr-2 h-4 w-4" />Heading 2 </DropdownMenuItem>
			<DropdownMenuItem @select="() => setHeading('h3')"> <Heading3 class="mr-2 h-4 w-4" />Heading 3 </DropdownMenuItem>
			<DropdownMenuItem @select="setBullet"> <List class="mr-2 h-4 w-4" />Bulleted list </DropdownMenuItem>
			<DropdownMenuItem @select="setNumber"> <ListOrdered class="mr-2 h-4 w-4" />Numbered list </DropdownMenuItem>
			<DropdownMenuItem @select="setQuote"> <Quote class="mr-2 h-4 w-4" />Quote </DropdownMenuItem>
			<DropdownMenuItem @select="setCode"> <Code class="mr-2 h-4 w-4" />Code block </DropdownMenuItem>
		</DropdownMenuContent>
	</DropdownMenu>
</template>
