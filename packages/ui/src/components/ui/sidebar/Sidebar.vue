...
import { SIDEBAR_WIDTH_MOBILE, useSidebar } from "@ui/sidebar/utils";
...
<template>
  ...
  >
    ...
    >
      <div
        data-sidebar="sidebar"
        class="bg-sidebar group-data-[variant=floating]:border-sidebar-border flex h-full w-full flex-col group-data-[variant=floating]:rounded-md group-data-[variant=floating]:border"
      >
        <slot />
      </div>
    </div>
