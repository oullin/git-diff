  ...
  >
    <div class="flex flex-col gap-6 p-6 md:p-10">
      <div class="flex items-center gap-2.5">
        <DiffLogo :size="28" />
        <span class="text-[14px] font-semibold tracking-tight" :style="{ color: 'var(--gd-text)' }">
          Git Diff
        </span>
      </div>
        ...
        >
          <form class="flex flex-col gap-6" @submit.prevent="submit">
            ...
            <div class="flex flex-col gap-4">
              ...
              <div class="grid gap-2">
                <Label for="confirm" :style="{ color: 'var(--gd-text-2)' }">
                  Confirm password
                </Label>
                <div class="relative">
                  <ShieldCheck
            ...
            <p
              class="text-center text-[11.5px] leading-relaxed"
              :style="{ color: 'var(--gd-text-muted)' }"
            >
              Your password stays on this device. It encrypts your local review data and never
              leaves your machine.
            </p>
          </form>
        </div>
