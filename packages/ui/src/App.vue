  ...
  >
    ...
    <ResizablePanelGroup direction="horizontal" class="min-h-0 flex-1 overflow-hidden">
          ...
          >
            ...
            >
              ...
              <AccordionContent class="px-2 pb-2 pt-0">
                ...
                <template v-else-if="trackedFiles.length === 0">
                  <div class="px-3 py-2 text-xs text-muted-foreground">No tracked files.</div>
                </template>
                <RepoFileTree
                  v-else
                  :paths="trackedFiles"
      ...
      >
        ...
        <div v-else class="grid min-h-0 flex-1 grid-cols-[280px_minmax(0,1fr)] overflow-hidden">
