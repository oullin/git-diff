import type { Branch, CommitSummary, FileSearchResult, PullRequestSummary, Repository, RepositoryCollaborator, RepositoryFile, RepositoryFileRange, RepositoryState } from '@git-diff/domain';
