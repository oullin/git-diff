...
import type { HighlightRequest, HighlightThemeId, PrewarmRequest, WorkerResponse } from '@workers/highlight-protocol';
...
export function requestHighlight(text: string, lang: BundledLanguage, theme: ThemeId): Promise<string> {
