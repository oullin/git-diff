...
export function addReviewEvent(socketPath, request) {
    return requestJson(socketPath, "POST", `/v1/reviews/${encodeURIComponent(request.reviewId)}/events`, {
        type: request.type,
...
export function createReviewComment(socketPath, request) {
    return requestJson(socketPath, "POST", `/v1/reviews/${encodeURIComponent(request.reviewId)}/comments`, {
        filePath: request.filePath,
...
export function updateReviewComment(socketPath, request) {
    return requestJson(socketPath, "PATCH", `/v1/reviews/${encodeURIComponent(request.reviewId)}/comments/${encodeURIComponent(request.commentId)}`, { bodyHtml: request.bodyHtml });
}
export function deleteReviewComment(socketPath, request) {
    return requestJson(socketPath, "DELETE", `/v1/reviews/${encodeURIComponent(request.reviewId)}/comments/${encodeURIComponent(request.commentId)}`);
}
