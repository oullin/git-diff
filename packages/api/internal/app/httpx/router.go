...
// BuildMux wires every /v1/* route to its handler. Grouped by resource for
// readability; the order is purely cosmetic since http.ServeMux uses the
// strongest pattern match.
func (s Server) BuildMux() *http.ServeMux {
	...
	// Branch operations: git CLI checkout/create + DB-backed lock/unlock.
	...
	// Repository registry + collaborators.
	...
	// Review sessions, events, comments.
